...
import 'package:mini_group_11/src/core/widgets/bottom_part_ic_mobile.dart';
import 'package:mini_group_11/src/core/widgets/bottom_part_ic_tab.dart';
import 'package:mini_group_11/src/core/widgets/info_expansion.dart';
import 'package:mini_group_11/src/core/widgets/info_expansion_text.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(
        context.checkDevice() == DeviceType.mobile ? 15.0 : 25.0,
      ),
